...
class Video_To_Image_Converter:
    ...
    """
    def __init__(self, input_file_list_arg: Union[List[str], str, None] = None, images_target_directory_arg: Union[str, None] = None, save_to_common_directory_arg: bool = True, common_directory_arg: str = "photos_common_directory"):
        """
        ...
        if save_to_common_directory_arg:
            if not os.path.exists(os.curdir + "/" + common_directory_arg):
                os.mkdir(os.curdir + "/" + common_directory_arg)
            if not common_directory_arg.endswith("/"):
                self.images_target_directory = common_directory_arg + "/"
            else:
                self.images_target_directory = common_directory_arg
...
if __name__ == "__main__":
    converter_obj = Video_To_Image_Converter("no20220721-121635-000005f.mp4",save_to_common_directory_arg=True)
