...
tcp_listening_socket_local_ip_address = "10.147.17.7"
tcp_listening_socket_local_port = 5000

tcp_listening_socket_remote_local_address = "10.147.17.7"
tcp_listening_socket_remote_port = 3001

udp_sending_socket_local_ip_address = "10.147.17.7"
udp_sending_socket_local_port = 6250

udp_sending_socket_remote_ip_address = "10.147.17.174"
...
while True:
    try:
        listening_tcp_socket.connect((tcp_listening_socket_remote_local_address, tcp_listening_socket_remote_port))
        break
...
# # Listening TCP socket starts listening for connections
# while True:
#     try:
...
#
# # Listening TCP socket accepts connection
# while True:
#     try:
...
# # Receive bytes from the listening TCP socket
# while True:
#     try:
